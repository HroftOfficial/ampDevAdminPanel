...
const onSelectFile = (event) => {
      ...
      renderCell: (params) => {
        return (
          <div className="allEditCell">
            <Link to={"/zakazesFiles/" + params.row._id}>
  ...
  return (
    <>
      ...
      >
        <DialogTitle id="responsive-dialog-title">
          {`Вы собираетесь сменить логотип пользователя ${currentOrg}`}
        </DialogTitle>
        <DialogContent>
          {/* <DialogContentText> */}
          ...
          />
                ...
                <Button variant="contained" component="span" className="imageButton">
                  поменять логотип
                </Button>
              </label> 
              </div>
        ...
        <Box component="div" sx={{ width:'auto', height:'500px', border: '1px dashed grey',
          position:'relative' }}> 
           { newImage ? 
              <Cropper
          image={newImage}
      ...
      <div className="userList">
        <h1 className="newUserTitle">Заказы(файлы и чертежи)</h1>
...
export default observer(ZakazFilesList);
