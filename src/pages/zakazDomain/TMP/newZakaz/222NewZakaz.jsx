...
import NewZakazStepThree from './NewZakazStepThree';
...
const NewZakaz = () => {
    ...
    const steps = [
        ...
        <NewZakazStepTwo next={handleNextStep} prev={handlePrevStep} data={data} currentStep={currentStep} steps2={steps2} handlePrevStep={handlePrevStep}/>,
        <NewZakazStepThree next={handleNextStep} prev={handlePrevStep} data={data} currentStep={currentStep} steps2={steps2} handlePrevStep={handlePrevStep}/>,
        <NewZakazStepTwo next={handleNextStep} prev={handlePrevStep} data={data} currentStep={currentStep} steps2={steps2} handlePrevStep={handlePrevStep}/>
      ];
